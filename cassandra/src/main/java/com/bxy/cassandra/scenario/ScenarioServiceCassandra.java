...
import com.bxy.cassandra.db.ScenarioRepositoryCassandraImpl;
import com.bxy.cassandra.db.ScenarioStepRepositoryCassandraImpl;
...
public class ScenarioServiceCassandra {
    ...
    @Autowired
    private ScenarioRepositoryCassandraImpl scenarioRepository;
    @Autowired
    private ScenarioStepRepositoryCassandraImpl scenarioStepRepository;
    ...
    public Scenario find(Long scenarioId) {
